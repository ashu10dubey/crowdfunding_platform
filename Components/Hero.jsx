          ...
          <div className="flex flex-col items-center justify-between xl:flex-row">
            <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
              <h2 className="max-w-lg  mb-6 font-sans  text-3xl font-bold tracking-tight text-white sm:text-5xl sm:leading-none">
                Crypto King <br className="hiddem md:block"/>
                Crowd Funding CK
              </h2>
              ...
              > 
                ...
                <svg
                  ...
                  viewBox="0 0 12 12"
                >  
                  <path d="M9.707,5.2931-5-5A1,1,0,0,0,3.293,1.707L7.586,6,3.293, 10. 293a1,1,0,1,0,1.414,1.41415-5A1,1,0,0,0,9.707,5.2932" /> 
                  </svg>
                </a>  
              </div>  
                    ...
                    <div className="mb-1 sm:mb-2">
                      ...
                      <div className="mb-1 sm:mb-2">
                        ...
                        <input
                          ...
                          required
                          type="text"
                          className="flex-grow w-full h-12 px-4 mb-2 transition duration-200 bg-white border border-gray-300 rounded shadow-sm apperance-none focus:border-deep-purple-accent-400 focus:outline-none focus:shadow-outline"
                          id="email"
                          name="email"
                        />
                      </div>
